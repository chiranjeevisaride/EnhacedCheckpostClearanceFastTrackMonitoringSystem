...
function submitForMandal() {
	document.customer.action='createClerk.jsp';
...
<br/><br/><br/>
<div>
<form name="customer" action="createClerkAction.jsp" method="POST" onSubmit="return validate();"/>
