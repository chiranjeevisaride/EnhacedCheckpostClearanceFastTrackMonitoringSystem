...
<%
	...
	if(rs.next() && rs.getInt(1)==0) {
		pstmt = con.prepareStatement("INSERT INTO EMPLOYEE(USERID, NAME,PASSWORD,DISTID,MANDALID,CREATED_ON) VALUES(?,?,?,?,?,?)");
		...
		pstmt.executeUpdate();
		request.setAttribute("response", "Employee Registration Successfully.");
			request.getRequestDispatcher("adminIndex.jsp").forward(request,response);
	} else {
		request.setAttribute("response", "Employee Already Exists Please Enter New USERID.");
