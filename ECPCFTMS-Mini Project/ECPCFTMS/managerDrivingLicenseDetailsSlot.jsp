...
<br/><br/><br/>
<div>
<form name="customer" action="managerDrivingLicenseDetailsSlotAction.jsp" method="POST"/>
<INPUT TYPE="HIDDEN" NAME="DRIVE_ID" VALUE="<%=request.getParameter("ID")%>"/> 
...
<b>MANAGER DRIVING LICENSE SLOT PAGE</b></font><br/>
