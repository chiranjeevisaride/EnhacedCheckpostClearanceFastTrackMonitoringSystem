...
<%
  if(session.getAttribute("ID")==null || session.getAttribute("CLERKID")==null) {
	...
	try {
		...
		ResultSet rsID = stmtID.executeQuery("SELECT ID FROM REG_VEHICLE WHERE REG_NO='"+request.getParameter("ID")+"'");
		if(rsID.next()) {
			id = rsID.getInt(1);
		}
		String sql = "SELECT REG_VEHICLE.*, (SELECT NAME FROM DIST WHERE REG_VEHICLE.DISTID=DIST.DISTID) AS DISTNAME,  (SELECT NAME FROM MANDAL WHERE MANDAL.MANDALID=REG_VEHICLE.MANDALID) AS MANDALNAME, (SELECT CODE FROM MANDAL WHERE MANDAL.MANDALID=REG_VEHICLE.MANDALID) AS MANDALNAME  FROM REG_VEHICLE WHERE ID="+id;
		Statement stmt = con.createStatement();
		ResultSet rs = stmt.executeQuery(sql);
		Statement stmt2 = con.createStatement();
		ResultSet rs2 = stmt2.executeQuery("SELECT * FROM REG_VEHICLE_VALID WHERE REG_ID="+id);
		Statement stmt3 = con.createStatement();
		ResultSet rs3 = stmt3.executeQuery("SELECT * FROM APPLYNOC WHERE ID=(SELECT MAX(ID) FROM APPLYNOC WHERE REG_ID="+id+" AND STATUS='ACCEPT')");
		Statement stmt4 = con.createStatement();
		ResultSet rs4 = stmt4.executeQuery("SELECT * FROM APPLYFITNESS WHERE ID=(SELECT MAX(ID) FROM APPLYFITNESS WHERE REG_ID="+id+" AND STATUS='ACCEPT')");
		Statement stmt5 = con.createStatement();
		ResultSet rs5 = stmt5.executeQuery("SELECT * FROM NATIONAL_PERMIT WHERE ID=(SELECT MAX(ID) FROM NATIONAL_PERMIT WHERE REG_ID="+id+" AND STATUS='ACCEPT')");
		
%>
<body>
<form name="manager" method="post" action="clerkVehicleDetailsChekAction.jsp">
	<div>
...
<b>CLERK VEHICLE DETAILS PAGE</b></font><br/>
...
<%if(rs5.next()) { %>
<tr>
<td align="left">PERMIT VALID FROM DATE</td>
<td width="2">&nbsp;</td>
<td width="10"><%=(rs5.getString("VALID_FROM")!=null)?rs5.getString("VALID_FROM"):""%></td>
</tr>
<tr>
<td align="left">PERMIT VALID TO DATE</td>
<td width="2">&nbsp;</td>
...
<tr>
<td align="left">FITNESS CLEAR</td>
<td width="2">&nbsp;</td>
<td width="10">
...
<tr>
<td align="left">PERMIT CLEAR</td>
<td width="2">&nbsp;</td>
<td width="10">
 <INPUT TYPE="RADIO" NAME="PERMIT" VALUE="YES"/>Yes
 <INPUT TYPE="RADIO" NAME="PERMIT" VALUE="NO"/>No (Manual Verify)
 </td>
</tr>
<tr>
<td align="left">REGISTRATION CLEAR</td>
<td width="2">&nbsp;</td>
<td width="10">
 <INPUT TYPE="RADIO" NAME="REG" VALUE="YES"/>Yes
 <INPUT TYPE="RADIO" NAME="REG" VALUE="NO"/>No (Manual Verify)
 </td>
</tr>
<tr>
...
<td width="10">
 ...
 <INPUT TYPE="RADIO" NAME="OTHER" VALUE="NO"/>No (Manual Verify)
 </td>
</tr>
<tr>
<td align="left">OTHER DESCRIPTION</td>
<td width="2">&nbsp;</td>
<td width="10"><textarea rows="5" cols="25" name="OTHER_DESC"></textarea></td>
</tr>
<tr>
<td align="left">FINE AMOUNT</td>
<td width="2">&nbsp;</td>
<td width="10">
 <INPUT TYPE="TEXT" NAME="FINE_AMT" value="0"/>(INR)
 </td>
</tr>
<tr>
...
<td width="2">&nbsp;</td>
<td width="10">
 <INPUT TYPE="TEXT" NAME="PAID_AMT" value="0"/>(INR)
 </td>
</tr>
<tr>
<td align="left">CHECK DATE DD/MM/YYYY</td>
<td width="2">&nbsp;</td>
<td width="180">
<SELECT name="FROMDD">
...
<tr>
<td align="left">CHECK HOUR:MINUTES</td>
<td width="2">&nbsp;</td>
<td >
<SELECT name="HH">
...
<tr>
<td colspan="3" align="center">
<input type="submit" value="INSERT PENALITY DETAILS">
</td>
</tr>
<tr><td colspan="3">&nbsp;</td></tr>
<tr>
<td colspan="3">
<font size="3"><a href="clerkIndex.jsp">Back</a></font>
</td>
</tr>
</table>
</td>
...
%>
<center>Vehicle Registration Not Found.&nbsp;<font size="3"><a href="clerkIndex.jsp">Back</a></font></center>
<%
}
	rs.close();
	stmt.close();
