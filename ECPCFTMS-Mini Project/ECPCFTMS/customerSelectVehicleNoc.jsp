...
<br/><br/><br/>
<div>
<form name="customer" action="customerSelectVehicleNocAction.jsp" method="POST"/>
...
<%
	try {
		...
		System.out.println("SELECT * FROM REG_VEHICLE WHERE CUST_ID="+session.getAttribute("ID"));
%>
<tr>
...
<tr>
<td colspan="3" align="center">
<input type="submit" value="APPLY NOC">
</td>
</tr>
