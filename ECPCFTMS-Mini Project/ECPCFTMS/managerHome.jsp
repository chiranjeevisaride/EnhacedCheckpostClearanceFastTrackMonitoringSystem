...
<form name="customer" action="managerLoginAction.jsp" method="post" onSubmit="return validate();"/>
<table align="center" STYLE="border:3px solid blue" border="1">
<tr>
<td colspan="3" align="center">
<font type="arial" color="blue" font size="4">
<b>MANAGER LOGIN PAGE</b></font><br/>
...
<td width="2">&nbsp;</td>
<td width="10"><input type=text name="USERID" size=15></td>
</tr>
<tr>
